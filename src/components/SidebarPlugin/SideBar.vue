    ...
    <div class="container-fluid">
      ...
      <div v-show="$sidebar.showSidebar" class="navbar-collapse collapse show" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
          <slot name="links">
            <sidebar-item
              :link="{ name: 'Home', icon: 'ni ni-tv-2 text-primary', path: '/home' }"
            />
            <sidebar-item
              :link="{ name: 'Clients', icon: 'ni ni-single-02 text-yellow', path: '/clients' }"
            />
            <sidebar-item
              :link="{ name: 'Quotes', icon: 'ni ni-paper-diploma text-info', path: '/quotes' }"
            />
            <sidebar-item
              :link="{ name: 'Invoices', icon: 'ni ni-money-coins text-green', path: '/invoices' }"
            />
            <sidebar-item
              :link="{ name: 'User Profile', icon: 'ni ni-single-02 text-yellow', path: '/profile' }"
            />
            <sidebar-item
              :link="{ name: 'Login', icon: 'ni ni-key-25 text-info', path: '/login' }"
            />
            <sidebar-item
